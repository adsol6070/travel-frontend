  ...
  return (
    <Slider {...sliderProps.destination} className="destination-active">
      ...
      >
        <div className="image">
          <img
            src="assets/images/destinations/abu-dhabi-destination.jpg"
            alt="Destination"
          />
        </div>
      ...
      >
        <div className="image">
          <img
            src="assets/images/destinations/dubai-destination.jpg"
            alt="Destination"
          />
        </div>
        <div className="content">
      ...
      >
        <div className="image">
          <img
            src="assets/images/destinations/jeddah-destination.jpg"
            alt="Destination"
          />
        </div>
        <div className="content">
      ...
      >
        <div className="image">
          <img
            src="assets/images/destinations/singapore-destination.jpg"
            alt="Destination"
          />
        </div>
        <div className="content">
